									...
									<ul class="dropdown-menu" role="menu">
											...
											<a href="#">
												<div class="media">
													<div class="media-left">
														<img class="media-object" src="${contextRoot}/assets/img/user1.png" alt="Antonio">
													</div>
										...
										<li class="inbox-item unread clearfix">
											<a href="#">
												<div class="media">
													<div class="media-left">
														<img class="media-object" src="${contextRoot}/assets/img/user2.png" alt="Antonio">
													</div>
													<div class="media-body">
										...
										<li class="inbox-item unread clearfix">
											<a href="#">
												<div class="media">
													<div class="media-left">
														<img class="media-object" src="${contextRoot}/assets/img/user3.png" alt="Antonio">
													</div>
													<div class="media-body">
										...
										<li class="inbox-item clearfix">
											<a href="#">
												<div class="media">
													<div class="media-left">
														<img class="media-object" src="${contextRoot}/assets/img/user4.png" alt="Antonio">
													</div>
													<div class="media-body">
										...
										<li class="inbox-item clearfix">
											<a href="#">
												<div class="media">
													<div class="media-left">
														<img class="media-object" src="${contextRoot}/assets/img/user5.png" alt="Antonio">
													</div>
													<div class="media-body">
